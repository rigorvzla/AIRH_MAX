...
{
    public partial class LinealMD : UserControl
    {
        public LinealMD()
        {
            InitializeComponent();
        ...
        private void Monitor()
        {
            ...
            Dispatcher.Invoke(() => txbRAM.Text = NormalizeFileSize(ram.Actual).Replace("MB", "") + "/" + NormalizeFileSize(ram.Total).Replace("MB", "GB"));

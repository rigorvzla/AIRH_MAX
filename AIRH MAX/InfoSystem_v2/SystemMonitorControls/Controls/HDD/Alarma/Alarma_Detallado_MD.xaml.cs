...
namespace SystemMonitorControls.HDD.Alarma
{
    public partial class Alarma_Detallado_MD : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                HandleError("Error al cargar configuraciones HDD", ex);
            }
        }

        private void LoadStoredSettings()
        {
            var hddSettings = Propiedades.CargarPropiedad.HDD();

            // ✅ ASIGNACIÓN SEGURA CON VALIDACIÓN
            txb_TemperaHDD.Text = hddSettings.Count > 1 ? hddSettings[1] : "0";
            txt_CargaHDD.Text = hddSettings.Count > 0 ? hddSettings[0] : "0";
            cbActivar.IsChecked = Propiedades.Estado.HDD;
        }
        #endregion
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                if (ValidateInputs())
                {
                    Propiedades.GuardarPropiedad.HDD(
                        true,
                        txt_CargaHDD.Text,
                        txb_TemperaHDD.Text);
                }
            ...
            {
                HandleError("Error al activar alerta HDD", ex);
                cbActivar.IsChecked = false;
            }
        }
        ...
        private void cbActivar_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                Propiedades.GuardarPropiedad.HDD(false, "0", "0");
            }
            catch (Exception ex)
            {
                HandleError("Error al desactivar alerta HDD", ex);
            }
        }
        #endregion
        ...
        private bool IsValidTemperature(string temperature)
        {
            ...
            {
                // ✅ RANGO RAZONABLE PARA TEMPERATURA HDD/SSD
        ...
        {
            MessageBox.Show(
                "Por favor, ingrese valores válidos para HDD/SSD:\n" +
                "- Temperatura: 0-100°C\n" +
                "- Carga: 0-100%",
                "Validación de Entrada HDD",
                MessageBoxButton.OK,
        ...
        private void TxtHDD_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                HandleError("Error en validación de teclado HDD", ex);
                e.Handled = true;
            }
        }
        ...
        private void Window_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                HandleError("Error al mover ventana HDD", ex);
            }
        }
        ...
        private void HandleError(string message, Exception ex)
        {
            ...
            // MessageBox.Show($"{message}: {ex.Message}", "Error HDD", MessageBoxButton.OK, MessageBoxImage.Error);
        }
        #endregion
    }
}